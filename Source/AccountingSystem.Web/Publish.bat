...
call docker build -t atkseegow/accountingsystem_web:1.0.0 .
call docker push atkseegow/accountingsystem_web:1.0.0

call docker tag atkseegow/accountingsystem_web:1.0.0 atkseegow/accountingsystem_web:latest 
